...
configure<ApplicationExtension> {
    ...
    defaultConfig {
        applicationId = "com.paravel.video"
        resValue("string", "app_name", "Paravel Video")
        minSdk {
    ...
    buildTypes {
        ...
        release {
            System.getProperty("packageSuffix")?.let { suffix ->
                ...
                resValue("string", "app_name", "Paravel Video $suffix")
            }
        ...
        register("continuous") {
            ...
            if (normalizedWorkingBranch.isEmpty() || workingBranch in defaultBranches) {
                ...
                resValue("string", "app_name", "Paravel Video Continuous")
            } else {
                applicationIdSuffix = ".continuous.$normalizedWorkingBranch"
                resValue("string", "app_name", "Paravel Video $workingBranch")
            }
        }
    }
